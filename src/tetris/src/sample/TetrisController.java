...
public class TetrisController {
    ...
    public void MoveRight1(Form form) {
        if (form.a.getX() + TetrisGameLogic.MOVE <= (TetrisGameLogic.XMAX + 450) - TetrisGameLogic.SIZE && form.b.getX() + TetrisGameLogic.SIZE <= (TetrisGameLogic.XMAX + 450) - TetrisGameLogic.SIZE
                && form.c.getX() + TetrisGameLogic.SIZE <= (TetrisGameLogic.XMAX + 450) - TetrisGameLogic.SIZE && form.d.getX() + TetrisGameLogic.SIZE <= (TetrisGameLogic.XMAX + 450) - TetrisGameLogic.SIZE) {
            int movea = gameLogic.MESH1[((int) form.a.getX() / TetrisGameLogic.SIZE) + 1][((int) form.a.getY() / TetrisGameLogic.SIZE)];
            int moveb = gameLogic.MESH1[((int) form.b.getX() / TetrisGameLogic.SIZE) + 1][((int) form.b.getY() / TetrisGameLogic.SIZE)];
            int movec = gameLogic.MESH1[((int) form.c.getX() / TetrisGameLogic.SIZE) + 1][((int) form.c.getY() / TetrisGameLogic.SIZE)];
            int moved = gameLogic.MESH1[((int) form.d.getX() / TetrisGameLogic.SIZE) + 1][((int) form.d.getY() / TetrisGameLogic.SIZE)];
            if (movea == 0 && movea == moveb && moveb == movec && movec == moved) {
                form.a.setX(form.a.getX() + TetrisGameLogic.SIZE);
                form.b.setX(form.b.getX() + TetrisGameLogic.SIZE);
                form.c.setX(form.c.getX() + TetrisGameLogic.SIZE);
